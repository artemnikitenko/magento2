...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    private function _createPostTable(SchemaSetupInterface $setup)
    {
        ...
        if (!$installer->tableExists('practice_dev_post')) {
            $table = $installer->getConnection()->newTable($installer->getTable('practice_dev_post'))
                ->addColumn(
                    'post_id',
            ...
            $installer->getConnection()->addIndex(
                $installer->getTable('practice_dev_post'),
                $setup->getIdxName(
                    $installer->getTable('practice_dev_post'),
